...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","SCM_ARD","PASSWD"}, \
				{0,-1,"","SCM_LIN","PASSWD"},  {0,-1,"","SCM_AND","PASSWD"}, \
				{0,-1,"","SCM_STM32","PASSWD"},  {0,-1,"","SCM_BT","PASSWD"}, \
				{0,-1,"","SCM_SQL","PASSWD"},  {0,-1,"","7","PASSWD"}, \
